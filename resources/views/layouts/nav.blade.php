...
<br>
    ...
    <footer class="border-t-2 py-16 flex flex-col ">
            ...
            <div>
                ...
                <ul>
                    <li class="mb-4"><a href="#" target="_blank"
                                        class="text-gray-600 hover:underline"></a></li>
        ...
        <div class=" flex flex-col items-center justify-around">
            ...
            <span class="text-sm text-gray-500 sm:text-center"><a href="https://github.com/MaxScholten" target="_blank" class="hover:underline">© 2024  Stonks Pizza. All Rights Reserved.</a></span>
        </div>
    </footer>
    </body>
