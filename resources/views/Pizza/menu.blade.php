            ...
            <div class='flex items-center justify-center min-h-screen from-[#F9F5F3] via-[#F9F5F3] to-[#F9F5F3] bg-gradient-to-br px-2'>
                <div class='w-full max-w-md  mx-auto bg-white rounded-3xl shadow-xl overflow-hidden'>
                    <div class='max-w-md mx-auto'>
                        <div class='h-[236px]' style='background-image:url(https://www.marionskitchen.com/wp-content/uploads/2023/02/Spicy-Salami-and-3-Cheese-Pizza-02.jpg);background-size:cover;background-position:center'>
                        </div>
                        <div class='p-4 sm:p-6'>
                            <p class='font-bold text-gray-700 text-[22px] leading-7 mb-1'>Pizza Salami</p>
                ...
                <div class='w-full max-w-md  mx-auto bg-white rounded-3xl shadow-xl overflow-hidden'>
                    <div class='max-w-md mx-auto'>
                        <div class='h-[236px]' style='background-image:url(https://media.istockphoto.com/id/1349383878/nl/foto/hawaiian-pizza-with-ham-and-pineapple.jpg?s=612x612&w=0&k=20&c=IBW-OrLpub8czBWFuumirO8-rdQUgQ0-5cjsYAXx63E=);background-size:cover;background-position:center'>
                        </div>
                        <div class='p-4 sm:p-6'>
                            <p class='font-bold text-gray-700 text-[22px] leading-7 mb-1'>Pizza Hawaii</p>
                            <div class='flex flex-row'>
                                <p class='text-[#3C3C4399] text-[17px] mr-2 line-through'>€ 15,-</p>
                                <p class='text-[17px] font-bold text-[#0FB478]'>€ 12,50</p>
                            </div>
                ...
                <div class='w-full max-w-md  mx-auto bg-white rounded-3xl shadow-xl overflow-hidden'>
                    <div class='max-w-md mx-auto'>
                        <div class='h-[236px]' style='background-image:url(https://www.tasteatlas.com/images/dishes/06fb0374204f4cf1bc636a4deb517976.jpg);background-size:cover;background-position:center'>
                        </div>
                        <div class='p-4 sm:p-6'>
                            <p class='font-bold text-gray-700 text-[22px] leading-7 mb-1'>Pizza Tonno</p>
                            <div class='flex flex-row'>
                                <p class='text-[#3C3C4399] text-[17px] mr-2 line-through'>€ 15,-</p>
                                <p class='text-[17px] font-bold text-[#0FB478]'>€ 12,50</p>
                            </div>
            ...
            <div class='flex items-center justify-center min-h-screen from-[#F9F5F3] via-[#F9F5F3] to-[#F9F5F3] bg-gradient-to-br px-2'>
                <div class='w-full max-w-md  mx-auto bg-white rounded-3xl shadow-xl overflow-auto'>
                    <div class='max-w-md mx-auto'>
                        ...
                        <div class='p-4 sm:p-6'>
                            <p class='font-bold text-gray-700 text-[22px] leading-7 mb-1'>Pizza Cheese</p>
                            <div class='flex flex-row'>
                                <p class='text-[#3C3C4399] text-[17px] mr-2 line-through'>€ 15,-</p>
                                <p class='text-[17px] font-bold text-[#0FB478]'>€ 12,50</p>
                            </div>
                ...
                <div class='w-full max-w-md  mx-auto bg-white rounded-3xl shadow-xl overflow-auto'>
                    <div class='max-w-md mx-auto'>
                        ...
                        <div class='p-4 sm:p-6'>
                            <p class='font-bold text-gray-700 text-[22px] leading-7 mb-1'>Pizza Salmon</p>
                            <div class='flex flex-row'>
                                <p class='text-[#3C3C4399] text-[17px] mr-2 line-through'>€ 15,-</p>
                                <p class='text-[17px] font-bold text-[#0FB478]'>€ 12,50</p>
                            </div>
